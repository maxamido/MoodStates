...
function preload() {
  images[0] = loadImage('assets/karaokestar-01.png');
...
drawOne = function() {
   ...
   fill(0,0,0);
   text("KARAOKE STAR", width/2, height - gTextOffset);
}
...
drawTwo = function() {
   ...
   fill(240,120,0);
   text("STOP SCHOOL", width/2, height - gTextOffset);
}
...
drawThree = function() {
   ...
   fill(40,230,120);
   text("WHY ME...?", width/2, height - gTextOffset);
}
...
drawFour = function() {
   ...
   fill(255,255,178);
   text("ZOMBIE", width/2, height - gTextOffset);
}
